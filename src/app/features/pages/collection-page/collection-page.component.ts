...
@Component({
  ...
  imports: [BasicLayoutComponent, InputButtonComponent, CenterModalComponent, InputFieldComponent,
    ResourceTableComponent, CommonModule, ReactiveFormsModule, RouterModule, DangerButtonComponent, FormsModule],
